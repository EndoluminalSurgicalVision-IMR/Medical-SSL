...
parser.add_argument('--network',  type=str, default='unet_2d_dense',choices=networks_name,
                    help='Networks')
...
parser.add_argument('--note', type=str, default='baseline_from_scratch',
                    help='model note ')
parser.add_argument('--eval_dataset', type=str, default='eyepacs_cls_per10',choices=datasets_name,
                    help='val data')
parser.add_argument('--input_size', type=int, default=[512, 512], help="inputimage size ")
...
parser.add_argument('--class_num', type=int, default=5, help="output feature channel")
parser.add_argument('--normalization', type=str, choices=['sigmoid', 'softmax', 'none'],
                    default=None, help="the normalization of output")
parser.add_argument('--loss', type=str, default='mse', help="training loss function")
parser.add_argument('--val_batch', type=int, default=96, help="val_batch")
...
if __name__ == '__main__':
    ...
    Tester = Classification2DTester(args)
