...
parser.add_argument('--network',  type=str, default='unet_3d',choices=networks_name,
                    help='Networks')
...
parser.add_argument('--eval_dataset', type=str, default='msd_liver_seg_test_down2',choices=datasets_name,
                    help='val data')
...
parser.add_argument('--normalization', type=str, choices=['sigmoid', 'softmax', 'none'],
                    default='softmax', help="the normalization of output")
parser.add_argument('--test_cut_params', type=dict, default={'patch_d': 32,
                       'patch_h': 160,
                       'patch_w': 160,
                       'stride_d': 16,
                       'stride_h': 80,
                       'stride_w': 80}, help=" the params for cutting patches in test stage")
...
parser.add_argument('--model_path', type=str, default= '../checkpoints/msd_liver_seg_train_down2/unet_3d_Simple_msd_liver_seg_RKB_orders_100_nnunet_stage0/20220730-091353/best_model.pth')
parser.add_argument('--save_results_path', type=str, default='../results/test_msd_liver_seg_RKB')
