...
parser.add_argument('--eval_dataset', type=str, default='luna_ncs',choices=datasets_name,
                    help='val data')
...
parser.add_argument('--input_size', type=int, default=[64, 64, 32], help="crop input size")
